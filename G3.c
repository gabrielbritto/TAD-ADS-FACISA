...
void mostravetor(int * vetor, int qtdDeElementosDoVetor){
  int iterador;
        printf("[ ");
      ...
      int maiornumero(int * vetor, int qtdDeElementosDoVetor){
...
void radixSort(int * vetor, int qtdDeElementosDoVetor){
  ...
  */
  ...
  int maiorNumeroDoVetor = maiornumero(vetor, qtdDeElementosDoVetor);
  
  while (maiorNumeroDoVetor / digitoMenosSignificativo > 0){
    
    mostravetor(vetor, qtdDeElementosDoVetor);
...
setlocale(LC_ALL, "Portuguese");     
  ...
  int iterador;
  	...
  	do{
		  ...
		  printf("\nLista desordenada: ");
		  mostravetor(&lista[0], qtdDeElementosDoVetor);
